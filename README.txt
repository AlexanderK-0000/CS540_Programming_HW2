...
Instructions to Run:
	Go to this website: https://www.onlinegdb.com/online_python_compiler
	Double check the langauge in the top right is Python 3
	Copy and paste the entire contents of HW2.py into the website
	Press Run
